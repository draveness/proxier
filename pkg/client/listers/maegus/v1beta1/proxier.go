...
// List lists all Proxiers in the indexer.
func (s *proxierLister) List(selector labels.Selector) (ret []*v1beta1.Proxier, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.Proxier))
	})
	return ret, err
}
...
// List lists all Proxiers in the indexer for a given namespace.
func (s proxierNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.Proxier, err error) {
...
// Get retrieves the Proxier from the indexer for a given namespace and name.
func (s proxierNamespaceLister) Get(name string) (*v1beta1.Proxier, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("proxier"), name)
	}
	return obj.(*v1beta1.Proxier), nil
}
